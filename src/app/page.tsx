      ...
      <main>
        ...
        <div className="relative isolate overflow-hidden">
          <svg
            ...
            w-full stroke-white/10 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]"
            aria-hidden="true"
          >
            <defs>
              <pattern
          ...
          <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-40 lg:flex lg:px-8 lg:pt-40">
            ...
            <div className="mx-auto mt-16 flex max-w-2xl sm:mt-24
             lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
