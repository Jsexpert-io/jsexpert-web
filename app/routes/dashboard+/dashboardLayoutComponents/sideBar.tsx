...
export const SideBar = (
    {
        ...
        navigation, teams, showNavigations, projects, currentProject, setCurrentProject
    }: {
                                            ...
                                            <span
                                                className={classNames(
                                                    team.current
                                                        ...
                                                        : 'text-gray-400 border-gray-200 group-hover:border-slate-600 group-hover:text-slate-600',
